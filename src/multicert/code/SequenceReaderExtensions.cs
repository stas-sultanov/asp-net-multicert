...
/// that allows reading of endian specific numeric values from binary data.
/// </summary>
internal static class SequenceReaderExtensionsUnsigned
{
	...
	/// <summary>
	/// Tries to read an UInt24 as big endian.
	/// </summary>
	/// <param name="reader">The byte sequence reader instance from which the value is to be read.</param>
	/// <param name="value">When the method returns, the value read out of the byte sequence reader, as big endian.</param>
	/// <returns><c>true</c> if the read operation is successful; <c>false</c> if there isn't enough data for an UInt24.</returns>
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
